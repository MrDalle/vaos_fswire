                        ...
                        <div class="bg-image" style="background-image: url('assets/img/photos/photo6@2x.jpg');">
                            <div class="block-content bg-primary-dark-op text-center overflow-hidden">
                                <div class="push-30-t push animated fadeInDown">
                                    <img class="img-avatar img-avatar96 img-avatar-thumb" src="{{ Auth::user()->avatar_url }}" alt="">
                                </div>
                                <div class="push-30 animated fadeInUp">
                                    <h2 class="h4 font-w600 text-white push-5">{{ Auth::user()->username }}</h2>
                        ...
                        <div class="block-content text-center">
                            <div class="row items-push text-uppercase">
                                <div class="col-xs-6 col-sm-3">
                                    ...
                                    <a class="h2 font-w300 text-primary animated flipInX" href="javascript:void(0)">{{ Auth::user()->totalhours }}</a>
                                </div>
                                <div class="col-xs-6 col-sm-3">
