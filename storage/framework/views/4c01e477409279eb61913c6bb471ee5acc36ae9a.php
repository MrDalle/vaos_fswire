                ...
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="block block-themed animated bounceIn">
                        ...
                        <div class="block-content block-content-full block-content-narrow">
                          ...
                          <form class="js-validation-login form-horizontal push-30-t" action="<?php echo e(url('/login')); ?>" class="form-horizontal" method="POST" role="form">
                              ...
                              <div class="form-group">
                                  <div class="col-xs-12">
                                      <div class="form-material form-material-primary floating">
                                        ...
                                        <?php endif; ?> <?php if($errors->has('username')): ?>
                                        <div class="alert alert-danger" role="alert">
                                            <strong>
                                                Oh snap!
                                            </strong>
