            ...
            <div class="content content-narrow">
                <div class="block block-transparent">
                    <div class="block-content block-content-full">
                        ...
                        <h2 class="h4 font-w300 text-white-op animated fadeInUp">Welcome <?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-6 col-sm-3">
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <a class="h2 font-w300 text-primary" href="base_comp_charts.html" data-toggle="countTo" data-to="<?php echo e(Auth::user()->totalhours); ?>"></a>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 col-sm-3">
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <a class="h2 font-w300 text-primary" href="base_comp_charts.html" data-toggle="countTo" data-to="<?php echo e(\App\PIREP::where('user_id', Auth::user()->id)->count()); ?>"></a>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 col-sm-3">
                <div class="block block-rounded">
                    <div class="block-content block-content-full">
                        ...
                        <a class="h2 font-w300 text-primary" href="base_comp_charts.html" data-toggle="countTo" data-to="<?php echo e(\App\PIREP::where('user_id', Auth::user()->id)->avg('landingrate')); ?>" data-before="-" data-after="FPM"></a>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 col-sm-3">
