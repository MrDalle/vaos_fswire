...
<html lang="en">
        ...
        <meta content="<?php echo e(config('app.name', 'VAOS')); ?> | Login to your airline" name="description">
    ...
    <body class="noscroll">
                    ...
                    <div class="card-group" style="margin: 0px; padding: 0px;">
                        <div class="card p-a-2" style="margin: 0px;">
                            <div class="card-block" style="padding-bottom: 180%; padding-top: 15%; margin: 0px; height: 100% !important;">
                                ...
                                <form action="<?php echo e(url('/password/reset')); ?>" class="form-horizontal" method="POST" role="form">
                                    ...
                                    <div class="input-group m-b-1">
                                        ...
                                        <input class="form-control" name="email" placeholder="Email" type="text" value="<?php echo e(isset($email) ? $email : old('email')); ?>" required autofocus>
                                        </input>
        ...
        <script src="<?php echo e(asset('bower_components/jquery/dist/jquery.min.js')); ?>">
        </script>
        <script src="<?php echo e(asset('bower_components/tether/dist/js/tether.min.js')); ?>">
        </script>
        <script src="<?php echo e(asset('bower_components/bootstrap/dist/js/bootstrap.min.js')); ?>">
        </script>
        <script>
