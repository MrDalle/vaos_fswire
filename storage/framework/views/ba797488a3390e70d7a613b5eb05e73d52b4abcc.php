    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a href="<?php echo e(url('/setup?mode=settings')); ?>" role="button" class="btn btn-lg btn-primary btn-block">Start Fresh</a>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a disabled href="<?php echo e(url('/setup?mode=settings')); ?>" role="button" class="btn btn-lg btn-primary btn-block">Import Existing phpVMS VA</a>
            </div>
        </div>
    </div>
</div>
